...
const SettingThreadChangeJoinCondition = () => {
    ...
    let {join_condition} = useSelector(state => {
        ...
        if (!Thread) return {}
        return {join_condition:Thread.join_condition}
    ...
    const handleSubmitWhoCanEditThread = ()=>{
        ...
        dispatch({
            type:Action.API_UPDATE_THREAD_JOIN_CONDITION,
            data:{
                thread_id:thread_id,
                        ...
                        <View style={{
                            ...
                            >
                                <Text style={{
                                 ...
                                 <View style={{}}>
                                    {
                                        check1 || joinCondition ==="only_leader"
                                        ?
    ...
    return (
        <View>
             <TouchableOpacity
                    ...
                    <Feather name='user-check' size={25} color='#00A48D' />
...
export default SettingThreadChangeJoinCondition
