 ...
 * @platform android
 */
export declare enum AndroidNotificationSetting {
    /**
 ...
 * @platform android
 */
export declare enum AndroidBadgeIconType {
    /**
 ...
 * @platform android
 */
export declare enum AndroidCategory {
    ALARM = "alarm",
    CALL = "call",
    EMAIL = "email",
    ERROR = "error",
 ...
 * @platform android
 */
export declare enum AndroidColor {
    RED = "red",
    BLUE = "blue",
    GREEN = "green",
    BLACK = "black",
 ...
 * @platform android API Level < 26
 */
export declare enum AndroidDefaults {
    /**
 ...
 * @platform android
 */
export declare enum AndroidGroupAlertBehavior {
    /**
 ...
 * @platform android
 */
export declare enum AndroidStyle {
    BIGPICTURE = 0,
    BIGTEXT = 1,
    INBOX = 2,
    MESSAGING = 3
 ...
 * @platform android
 */
export declare enum AndroidLaunchActivityFlag {
    /**
