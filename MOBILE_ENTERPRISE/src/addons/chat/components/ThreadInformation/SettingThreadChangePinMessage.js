...
const SettingThreadChangePinMessage = () => {
    ...
    const handleSubmitWhoCanEditThread = ()=>{
        ...
        dispatch({
            type:Action.API_UPDATE_THREAD_PIN_MESSAGE,
            data:{
                thread_id:thread_id,
                who_can_pin_message : whoCanPinMessage
            },
            setShowPermission
        })
    }
    useEffect(() => {
        setWhoCanPinMessage(who_can_pin_message)
        return () => {  
        }
    }, [])
    const permission = () => {
                        ...
                        <View style={{
                            ...
                            <TouchableOpacity style={{
                                ...
                                onPress={()=>{
                                    setCheck1(true)
                                    setCheck2(false)
                                    setWhoCanPinMessage("only_leader")
                                }}
                            >
                                <Text style={{
                                    flex:2,
                                 ...
                                 <View style={{}}>
                                    {
                                        check1 || whoCanPinMessage ==="only_leader"
                                        ?
    ...
    return (
        <View>
             <TouchableOpacity
                    ...
                    <AntDesign name='pushpino' size={25} color='#00A48D' />
...
export default SettingThreadChangePinMessage
